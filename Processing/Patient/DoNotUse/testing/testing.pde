...
void serialEvent(Serial myPort) {
  ...
  if (firstContact == false) {
    ...
    if (serialCount == 4 ) {
      ...
      ppg_pre_data = serialInArray[1];
      nibp_AC_data = serialInArray[2];
      nibp_DC_data = serialInArray[3];
      ppg_data = MA_Filter_PPG(ppg_pre_data);
      /*
      g_cnt++;
      if(g_cnt > 4){
...
//  int offset = (chart1_Ymax-chart1_Ymin)/2 + 500;
  ...
  stroke(PpgColor);
  line(chart2_X,pre_data2, chart2_X + 1, curr_data2);
  chart2_X = chart2_X + 1;
  if(chart2_X > chart1_Xmax){
    chart2_X = chart1_Xmin + 10;    
    chart2_draw();
  }//End of if()...
}//End of WaveformChart()...
...
//  int offset = (chart1_Ymax-chart1_Ymin)/2 + 500;
  ...
  stroke(NibpColor_AC);
  line(chart3_X,pre_data3 , chart3_X + 1, curr_data3 );
  chart3_X = chart3_X + 0.3;
  if(chart3_X > chart1_Xmax - 10){
    //chart1_X = chart1_Xmin
    chart3_X = chart1_Xmin + 10;    
    chart3_draw();
  }//End of if()...
}//End of WaveformChart()...
...
//  int offset = (chart1_Ymax-chart1_Ymin)/2 + 500;
  ...
  stroke(NibpColor_DC);
  line(chart4_X,pre_data4 , chart4_X + 1, curr_data4 );
  
  chart4_X = chart4_X + 0.3;
  

  if(chart4_X > chart1_Xmax - 10){
    //chart1_X = chart1_Xmin;
    chart4_X = chart1_Xmin + 10;    
    chart4_draw();
  }//End of if()...
}//End of WaveformChart()...
...
void chart1_draw(){
  ...
  //WaveformChart Initialize..
  fill(Gray);
  for (int i = 0; i<20; i++)
  rect(chart1_Xmin, chart1_Ymin, chart1_Xmax - chart1_Xmin, chart1_Ymax - chart1_Ymin);
}//End of chart1_draw()..
...
void chart2_draw(){
  ...
  fill(Gray);
  for (int i = 0; i<20; i++)
  rect(chart2_Xmin, chart2_Ymin, chart2_Xmax - chart2_Xmin, chart2_Ymax - chart2_Ymin);
}//End of chart1_draw()..
...
void chart3_draw(){
  ...
  fill(Gray);
  for (int i = 0; i<20; i++)
  rect(chart3_Xmin, chart3_Ymin, chart3_Xmax - chart3_Xmin, chart3_Ymax - chart3_Ymin);
}//End of chart2_draw()..
...
void chart4_draw(){
  ...
  fill(Gray);
  for (int i = 0; i<20; i++)
  rect(chart4_Xmin, chart4_Ymin, chart4_Xmax - chart4_Xmin, chart4_Ymax - chart4_Ymin);
}//End of chart2_draw()..

int MA_buffer[] = new int[8];

int MA_Filter_PPG(int data)
{
    int i;
    long MA_out = 0;
    for( i=0; i<7; i++ )  MA_buffer[i] = MA_buffer[i+1];
    MA_buffer[7] = data;
    for( i=0; i<8; i++ )  MA_out += MA_buffer[i];
    MA_out /= 8;
    return (int)MA_out;  
}//End of MA_Filter_PPG()..
